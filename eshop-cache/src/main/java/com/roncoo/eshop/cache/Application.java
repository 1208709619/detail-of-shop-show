...
import com.roncoo.eshop.cache.filter.HystrixRequestContextServletFilter;
...
//    }
    ...
    public JedisCluster JedisClusterFactory() {
        ...
        jedisClusterNodes.add(new HostAndPort("192.168.0.101", 7001));
        jedisClusterNodes.add(new HostAndPort("192.168.0.106", 7003));
