...
public class ProductInventoryController {
    ...
    public ProductInventory getProductInventory(Integer productId){
        System.out.println("===============日志==============；接收到一个商品库存的度请求，商品id="+productId);
        ...
        try {
            ...
            //将请求扔给service异步去处理之后，需要while(true)一会，在这里hang住
            ...
            while (true){
                ...
                if(productInventory!=null){
                    System.out.println("===============日志==============；在200ms内读取到了redis中的库存缓存，商品id="+productInventory.getInventoryCnt()+",商品库存数量="+productInventory.getInventoryCnt());
